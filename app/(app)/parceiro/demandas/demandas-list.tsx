      ...
      <div className="flex flex-wrap gap-3">
        <div className="relative flex-1 min-w-[200px]">
          ...
          <input
            ...
            className="w-full h-9 pl-9 pr-3 rounded-lg border border-border bg-card text-sm text-foreground placeholder:text-zinc-500 focus:border-lime-500 focus:outline-none focus:ring-1 focus:ring-lime-500"
          />
        </div>
        <select
          value={statusFilter}
          ...
          {filtered.map((d) => (
            ...
            >
              <div className="flex items-start justify-between gap-3 mb-2">
                <p className="text-sm font-semibold text-foreground leading-tight">{d.titulo}</p>
                <BadgeStatus status={d.status} />
              </div>

              <div className="inline-flex items-center rounded-md bg-brand-500/10 px-2 py-0.5 text-[10px] font-semibold text-brand-400 mb-3">
                {d.tipo}
              </div>
              ...
              <div className="flex gap-2 pt-3 border-t border-border">
                <Link
                  ...
                  className="flex-1"
                >
                  <Button size="sm" className="w-full gap-1 bg-brand-500 hover:bg-lime-600 text-foreground font-semibold">
